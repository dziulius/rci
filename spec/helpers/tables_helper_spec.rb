...
describe TablesHelper do
  ...
  it "should allow creating table for collection of models" do
    ...
    helper.output_buffer.should have_tag('table[cell_spacing=0][border=1]') do
      with_tag('tr') do
        with_tag('th', 'Name')
        with_tag('th', 'Leader')
      end
  ...
  it "should automatically add content for table bottom" do
    ...
    helper.output_buffer.should have_tag('table[cell_spacing=0][border=1]', :text => 'table bottom')
  end
